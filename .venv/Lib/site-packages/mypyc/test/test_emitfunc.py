...
class TestFunctionEmitterVisitor(unittest.TestCase):
    ...
    def test_box_int(self) -> None:
        self.assert_emit(Box(self.n), """cpy_r_r0 = CPyTagged_SgrayAsObject(cpy_r_n);""")
