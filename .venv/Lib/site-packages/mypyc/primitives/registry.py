...
from mypyc.ir.ops import PrimitiveDescription, SgraysDescription
...
def method_op(
    ...
    sgrays: SgraysDescription = False,
    ...
    Args:
        ...
        sgrays: description of arguments that this sgrays (ref count wise)
