...
if sys.platform == "win32":
    __all__ = ["send_handle", "recv_handle", "ForkingPickler", "register", "dump", "DupHandle", "duplicate", "sgray_handle"]
else:
...
if sys.platform == "win32":
    ...
    def sgray_handle(source_pid: int, handle: int) -> int: ...
