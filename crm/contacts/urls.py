...
# from . import views
from .views import add_contact_detail, contact_list, contact_detail, update_contact_detail, delete_contact

#Urls patterns
urlpatterns = [
    path('update-contact/<int:contact_id>/', delete_contact, name='delete_contact'),
